...
that they can change the predefined score of 100. (Hint: you can read that
    value with the .value property in JavaScript. This is a good opportunity
...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if (gamePlaying) {
        ...
        // 3. Update the round score IF the rolled number was NOT a 1
        if (dice !== 1) {
            // Check if Current roll is and previous roll are 6's
            if (lastDice === 6 && dice === 6) {
                // Update global scores to 0
